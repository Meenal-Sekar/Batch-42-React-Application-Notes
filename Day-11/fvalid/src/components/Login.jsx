   ...
   {/* body */}
    <div className='min-h-screen flex justify-center items-center bg-gray-200'>
         ...
         <div className='bg-white p-8 rounded-xl shadow-lg w-96'>
                 ...
                 <h2 className='text-2xl font-bold text-green-500 text-center mb-6'>Welcome back</h2>
                    ...
                    <button className='w-full bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-lg cursor-pointer'
